...
public class ServiceManager : IServiceManager
{
    ...
    public ServiceManager(Lazy<IAuthService> authService, Lazy<ICourseService> courseService, Lazy<IModuleService> moduleService, Lazy<IActivityService> activityService, Lazy<IUserService> userService)
    {
